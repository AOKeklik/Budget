    ...
    // submit budget method
        submitBudgetForm(){
            ...
            if(value === "" || value < 0){
                ...
                this.budgetFeedback.innerHTML = `<p>Value Cennot Be Empty Or Negative</p>`;
                const self = this; 

                setTimeout(function(){self.budgetFeedback.classList.remove("showItem")},2000);
            }else{
    ...
    // submit expense form
        submitExpenseForm(){
            ...
            if(expenseValue === '' || amountValue === '' || amountValue < 0){
                ...
                setTimeout(function(){self.expenseFeedback.classList.remove("showItem")},2000);
            }else{
    ...
    // edit expense
        editExpense(element){
            ...
            this.amountInput.value = expense[0].amount;//show value

            let tempList = this.itemList.filter(function(item){return item.id !== id});
            this.itemList = tempList;//remove from list
